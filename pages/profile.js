    ...
    return (
      <React.Fragment>
        <Head
          ...
          description={`${
            currentProfile.companyName
          } is one of the best vendors on CelebratON | Hire or Book the best Wedding Planners, Surprise Planners and Birthday Planners in a few clicks on CelebratON`}
        />
              ...
              <Row type="flex" align="middle">
                <Col span={8}>
                  <h4
                    ...
                    className="profileIconFoot"
                  >
                    <span className="profileIconHead">Experience</span>
                    <br />
                    <Icon
                      type="schedule"
                      theme="twoTone"
                ...
                <Col span={8}>
                  <h4
                    ...
                    className="profileIconFoot"
                  >
                    <span className="profileIconHead">Events Covered</span>
                    <br />
                    <Icon
                      type="dashboard"
                      theme="twoTone"
                ...
                <Col span={8}>
                  <h4
                    ...
                    className="profileIconFoot"
                  >
                    <span className="profileIconHead">CelebratON</span>
                    <br />
                    <Icon
